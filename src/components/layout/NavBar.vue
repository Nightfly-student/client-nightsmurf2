...
m38 -75 c-3 -3 -9 2 -12 12 -6 14 -5 15 5 6 7 -7 10 -15 7 -18z"
                      ...
                      >RU Accounts</router-link
                    >
                  </li>
                  <li>
                    <router-link class="dropdown-item" to="/lol-skin-accounts"
                      ><BIconGlobe class="me-1" /> Skin Accounts</router-link
                    >
                  </li>
                </ul>
              </li>
            ...
            >
              ...
              <li>
                <a
                  class="dropdown-item"
                  role="button"
                  @click="this.$store.dispatch('logout'); this.$router.push('/')"
                  href="#"
                  >Logout</a
                >
              </li>
